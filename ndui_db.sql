...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 20 Avril 2017 à 11:20
...
(7, 'IDS', '#ffc266', 'Cube1', '#ff9900'),
(8, 'NAT', '#668cff', 'Cube1', '#0033cc'),
(9, 'virtual_link', '#d5ff80', 'Clock', '#99e600'),
(10, 'start', '#cccccc', 'Circle', '#666666'),
(11, 'input', '#cce5ff', 'ManualInput', '#0063cc');
