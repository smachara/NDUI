...
class NetworkConfigControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/nconfig/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'networkconfig[name]' => 'Lorem ipsum dolor sit amet',
            'networkconfig[description]' => 'Lorem ipsum dolor sit amet',
            'networkconfig[config_value]' => 'Lorem ipsum dolor sit amet',
                    ]);
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/nconfig/new');
        $form = $crawler->filter('form button[type="submit"]')->form();
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'networkconfig[name]' => 'Changed',
            'networkconfig[description]' => 'Changed',
            'networkconfig[config_value]' => 'Changed',
