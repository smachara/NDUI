...
class RemoteSvrControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/rsvr/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'remotesvr[name]' => 'Lorem ipsum dolor sit amet',
            'remotesvr[lastConfig]' => 'Lorem ipsum dolor sit amet',
            'remotesvr[url]' => 'Lorem ipsum dolor sit amet',
            'remotesvr[lastConfigDate]' => 'Lorem ipsum dolor sit amet',
                    ]);
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/rsvr/new');
        $form = $crawler->filter('form button[type="submit"]')->form();
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'remotesvr[name]' => 'Changed',
            'remotesvr[lastConfig]' => 'Changed',
            'remotesvr[url]' => 'Changed',
            'remotesvr[lastConfigDate]' => 'Changed',
