...
class NetworkFunctionControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/networkfunction/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'networkfunction[name]' => 'Lorem ipsum dolor sit amet',
            'networkfunction[attributes]' => 'Lorem ipsum dolor sit amet',
                    ]);
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/networkfunction/new');
        $form = $crawler->filter('form button[type="submit"]')->form();
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'networkfunction[name]' => 'Changed',
            'networkfunction[attributes]' => 'Changed',
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form([
            'networkfunction_filter[name]' => 'First%',
            'networkfunction_filter[attributes]' => 'First%',
