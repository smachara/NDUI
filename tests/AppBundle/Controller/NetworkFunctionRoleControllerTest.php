...
class NetworkFunctionRoleControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/networkfunctionrole/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'networkfunctionrole[name]' => 'Lorem ipsum dolor sit amet',
            'networkfunctionrole[color]' => 'Lorem ipsum dolor sit amet',
            'networkfunctionrole[stroke]' => 'Lorem ipsum dolor sit amet',
            'networkfunctionrole[shape]' => 'Lorem ipsum dolor sit amet',
                    ]);
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/networkfunctionrole/new');
        $form = $crawler->filter('form button[type="submit"]')->form();
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form([
            'networkfunctionrole[name]' => 'Changed',
            'networkfunctionrole[color]' => 'Changed',
            'networkfunctionrole[stroke]' => 'Changed',
            'networkfunctionrole[shape]' => 'Changed',
    ...
    public function testEditError()
    {
        ...
        $crawler = $client->click($crawler->filter('table.records_list tbody tr td .btn-group a')->eq(1)->link());
        $form = $crawler->filter('form button[type="submit"]')->form([
            'networkfunctionrole[field_name]' => '',
