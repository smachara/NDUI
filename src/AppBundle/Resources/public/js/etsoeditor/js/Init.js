...
window.RESOURCES_PATH = window.RESOURCES_PATH || '/bundles/app/js/etsoeditor/resources';
window.RESOURCE_BASE = window.RESOURCE_BASE || window.RESOURCES_PATH + '/grapheditor';

window.STENCIL_PATH = window.STENCIL_PATH || '/bundles/app/js/etsoeditor/stencils';
window.IMAGE_PATH = window.IMAGE_PATH || '/bundles/app/js/etsoeditor/images';
