...
namespace smachara\GeneratorBundle\Generator;
...
class DoctrineCrudGenerator extends Generator
{
     ...
     * @param bool              $needSecurity     'Whether or not to generate feature-specific roles'
     ...
     */
    public function generate(BundleInterface $bundle, $entity, ClassMetadataInfo $metadata, $format, $routePrefix, $needWriteActions, $needSecurity, $forceOverwrite, $layout, $bodyBlock, $usePaginator = false, $theme = null, $withFilter = false, $withSort = false)
    {
    ...
    protected function generateControllerClass($forceOverwrite)
    {
        ...
        $this->renderFile('crud/controller.php.twig', $target, [
            ...
            'needSecurity' => $this->needSecurity,
        ]);
    }
    ...
    /**
     * Generates the delete.confirm.html.twig template in the final bundle.
     *
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    protected function generateDeleteView($dir)
    {
        $this->renderFile('crud/views/delete.confirm.html.twig.twig', $dir.'/delete.confirm.html.twig', [
            'route_prefix' => $this->routePrefix,
            'route_name_prefix' => $this->routeNamePrefix,
            'entity' => $this->entity,
            'bundle' => $this->bundle->getName(),
